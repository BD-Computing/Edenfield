...
<body>
                ...
                <div class="hidden md:hidden bg-white border-t-2 py-2" id="mobileMenu">
                    <div class="flex flex-col">
                        ...
                        <div class="flex justify-between items-center border-t-2 pt-2">
                            <a href="{{ route('contact') }}"
                                class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-[var(--primary)] hover:border-[var(--primary)]">
                                Get In Touch
                            </a>
                        </div>
                    </div>
    ...
    <footer class="bg-white lg:grid lg:grid-cols-5 shadow-lg">
        <div class="relative block h-32 lg:col-span-2 lg:h-full">
            <img src="{{ URL::asset('images/mic.jpg') }}" alt=""
                ...
                <div>
                    ...
                    <div class="flex mt-8 space-x-6 text-gray-600">
                        ...
                        @if (!is_null($settings->tiktok_link))
                            <a class="hover:opacity-75" href="{{ $settings->tiktok_link }}" target="_blank"
                                rel="noreferrer">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <ul class="mt-6 space-y-4 text-sm">
                            <li>
                                <a class="text-gray-700 transition hover:opacity-75" target="_blank"
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4 text-sm">
                            <li>
                                <a href="{{ route('about') }}" class="text-gray-700 transition hover:opacity-75">
                                    About </a>
                            </li>

                            <li>
                                <a href="{{ route('services') }}" class="text-gray-700 transition hover:opacity-75">
                                    Services
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('contact') }}" class="text-gray-700 transition hover:opacity-75">
                                    Contact Us
                                </a>
                            </li>
                        </ul>
            ...
            <div class="mt-12 border-t border-gray-100 pt-12">
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <p class="mt-8 text-xs text-gray-500 sm:mt-0">
                        &copy; <span id="year"></span> {{ $settings->companyName }} -
                        <span class="rise-shake text-[var(--primary)]">Developed By <a
