...
<head>
    ...
    <meta content="Official BD Computing Website" name="description">
    <meta content="BD Computing" name="author">
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ URL::asset('hotel/img/logo-dark.png') }}">

    <!-- Layout config Js -->
    <script src="{{ URL::asset('backend/assets/js/layout.js') }}" defer></script>
    <!-- Bootstrap Css -->
...
<body>
    ...
    <div class="auth-page-wrapper pt-5">
        ...
        <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
            ...
            <canvas class="particles-js-canvas-el" width="938" height="380"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">{{ $settings->companyName }}</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">©
                                ...
                                </script>{{ date('Y') }} {{ $settings->companyName }}. Developed
                                with <i class="mdi mdi-heart text-danger"></i> by <a
                                    href="https://bdcomputinglimited.com">BD Computing Limited</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{ URL::asset('backend/assets/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ URL::asset('backend/assets/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
