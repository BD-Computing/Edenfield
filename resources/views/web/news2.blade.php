...
@section('content')
    ...
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4"
        data-background="{{ URL::asset('hotel/img/slider/7.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.html"> <img src="{{ URL::asset('hotel/img/restaurant/2.jpg') }}"
                                            alt=""> </a>
                                    <div class="date">
                                ...
                                <div class="post-cont">
                                    ...
                                    <p>Hotel potenti fringilla pretium ipsum non blandit. Vivamus eget nisi non mi iaculis
                                        iaculis imperie quiseros sevin elentesque habitant morbi tristique senectus et netus
                                        et malesuada fames ac turpis enesta mauris suscipit mis nec est aliquam, a tincidunt
                                        eros iacu suscipit risus eu ullamcorper fauibu.</p>
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.html"> <img src="{{ URL::asset('hotel/img/spa/3.jpg') }}" alt="">
                                    </a>
                                    <div class="date">
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.html"> <img src="{{ URL::asset('hotel/img/slider/7.jpg') }}"
                                            alt=""> </a>
                                    <div class="date">
